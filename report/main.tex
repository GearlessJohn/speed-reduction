...
\begin{enumerate}
	...
	\item \textbf{Forecasts of future freight prices: } With the help of the \textit{IFRS 9: Maritime asset financing LGD} model, it is possible to forecast freight prices for future markets, thus enabling better model accuracy.
\end{enumerate}
