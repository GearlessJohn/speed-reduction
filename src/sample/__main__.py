...
market = GlobalEnv(ifo380_price=494.0, vlsifo_price=631.5, carbon_tax_rates=2000.0)
...
# stm = Settlement(
#     vessel=vessels[1], route=shg_rtm, global_market=market, utilization_rate=0.95
# )
...
mf = MeanField(vessels_virtual, shg_rtm, market, q=0.15, value_exit=0)
